            ...
            <div class="p-6 md:p-8">
                <form method="POST" action="{{ route('mahasiswa.login') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <select name="semester" class="w-full px-4 py-3 border border-gray-200 rounded-xl appearance-none bg-white cursor-pointer focus:border-teal-400 focus:ring-2 focus:ring-teal-100 transition-all duration-200">
